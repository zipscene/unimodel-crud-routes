...
const { ObjectMask, deepCopy, setPath, getPath, deletePath, isScalar } = require('zs-objtools');
		...
		return Promise.resolve()
			...
			.then(() => {
				...
				if (params.permissions) {
					...
					this.globalPermissions.getTargetGrant('global', exactMatchObj).check(exactMatches, 'writeMask.');
